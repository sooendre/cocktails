...
exports.getMostCommonIngredients = getMostCommonIngredients;
exports.findCocktailsByIngredients = findCocktailsByIngredients;
exports.categorizeIngredients = categorizeIngredients;
exports.extractUniqueIngredients = extractUniqueIngredients;
exports.parseCocktailsFromJSON = parseCocktailsFromJSON;
exports.getCompleteIngredientAnalysis = getCompleteIngredientAnalysis;
/**
 ...
 */
function analyzeIngredients(cocktails) {
 ...
 */
function getMostCommonIngredients(cocktails, limit = 10) {
 ...
 */
function findCocktailsByIngredients(cocktails, targetIngredients) {
    const targetSet = new Set(targetIngredients.map(ing => ing.toLowerCase()));
    return cocktails.filter(cocktail => {
        return cocktail.ingredients.some(ingredient => ingredient.ingredient &&
 ...
 */
function categorizeIngredients(uniqueIngredients) {
    const categories = {
        spirits: [],
        liqueurs: [],
        juices: [],
 ...
 */
function extractUniqueIngredients(cocktails) {
    const uniqueIngredients = new Set();
 ...
 */
function parseCocktailsFromJSON(jsonData) {
    try {
        const cocktails = JSON.parse(jsonData);
        if (!Array.isArray(cocktails)) {
 ...
 */
function getCompleteIngredientAnalysis(cocktails) {
    const analysis = analyzeIngredients(cocktails);
