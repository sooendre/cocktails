...
const ingredient_analyzer_1 = require("./src/utils/ingredient-analyzer");
// Load and parse the cocktails data
const cocktailsPath = (0, path_1.join)(__dirname, 'static', 'cocktails.json');
const cocktailsData = (0, fs_1.readFileSync)(cocktailsPath, 'utf-8');
const cocktails = (0, ingredient_analyzer_1.parseCocktailsFromJSON)(cocktailsData);
// Perform comprehensive analysis
const analysis = (0, ingredient_analyzer_1.getCompleteIngredientAnalysis)(cocktails);
...
const uniqueIngredients = (0, ingredient_analyzer_1.extractUniqueIngredients)(cocktails);
...
(0, fs_2.writeFileSync)('cocktail-analysis-results.json', JSON.stringify(analysisOutput, null, 2));
